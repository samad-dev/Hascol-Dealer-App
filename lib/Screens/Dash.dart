                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          TextButton(
                                                                ...
                                                                actions: <Widget>[
                                                                  TextButton(
                                                                      ...
                                                                      onPressed:() async {
                                                                        ...
                                                                        print('http://151.106.17.246:8080/pandamart_close/api/trip_start.php?orderid=${_foundUsers[index].id}&start_time=${current_date.toString()}');
                                                                ...
                                                                actions: <Widget>[
                                                                  TextButton(
                                                                      ...
                                                                      onPressed:() async {
                                                                        ...
                                                                        DateTime current_date = DateTime.now();
                                                                        var request = http.Request
                                                                        ('GET', Uri.parse('http://151.106.17.246:8080/pandamart_close/api/trip_close_by_driver.php?orderid=${_foundUsers[index].id}&close_time=${current_date.toLocal().toString()}&lat_lng=${_currentPosition!.latitude.toString()} ${_currentPosition!.longitude.toString()}'));
                                                                        ui.Image image =
                                            ...
                                            child: Text(status==true ?'End Delivery':'Start Delivery'),
                                          )
                                        ],
                                      ),
                                      SizedBox(
